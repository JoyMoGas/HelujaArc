document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleScroll = () => {
        if (window.scrollY > 50) { // Ajusta el valor según el punto en el que quieras cambiar la posición
            ...
            logo.style.top = '0'; // Asegura que el logo esté pegado al borde superior de la navbar
            ...
            logo.style.margin = '0'; // Asegura que no haya margin cuando esté en la navbar
        } else {
            logo.style.position = 'absolute';
            logo.style.top = '110px'; // Ajusta según el espacio necesario en el body
            ...
            logo.style.margin = '0'; // Asegura que no haya margin cuando no está en la navbar
        }
    };
